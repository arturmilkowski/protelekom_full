...
class TypeTest extends TestCase
{
    ...
    public function testIndex(): void
    {
        ...
        $response = $this
            ->actingAs($this->user)
            ->getJson(route('api.products.types.index', $this->product));
    ...
    {
        $this->withoutExceptionHandling();
        $response = $this->postJson(route('api.products.types.store', $this->product), $this->type1->toArray());
    ...
    {
        $response = $this->postJson(route('api.products.types.store', $this->product), $this->type2->toArray());
    ...
    {
        $this->withoutExceptionHandling();
        $response = $this->getJson(route('api.products.types.show', [$this->product, $this->product->types[0]]));
    ...
    public function testUpdate(): void
    {
        ...
        $response = $this->putJson(route('api.products.types.update', [$this->product, $this->product->types[0]]), $this->type1->toArray());
    ...
    {
        $response = $this->putJson(route('api.products.types.update', [$this->product, $this->product->types[0]]), $this->type2->toArray());
    ...
    {
        $this->withoutExceptionHandling();
        $response = $this->deleteJson(route('api.products.types.destroy', [$this->product, $this->product->types[0]]));
